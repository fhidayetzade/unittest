...
public class ProductControllerRedis {
    ...
    public Product product(@PathVariable Long id, @RequestBody ProductRequestDto productRequestDto){
        return shoppingCartServiceRedis.update(id, productRequestDto);
    }
